package com.apj.platform.fm.v1.filters;
...
import com.apj.platform.fm.v1.commons.vo.MissingBearerToken;
import com.apj.platform.fm.v1.commons.vo.ParsedToken;
    ...
    protected void doFilterInternal(
        ...
        if (request.getRequestURI().contains("/actuator")) {
            ...
            if (authHeader == null || !authHeader.startsWith("Bearer ")) {
                throw new MissingBearerToken("missing bearer token");
            }
            ...
            try {
                ...
                if (res.getStatusCode() == HttpStatus.OK) {
                    ...
                    if (null != parsedToken) {
                        ...
                        throw new BadCredentialsException("incorrect crdentials");
                    }
                } else {
                    throw new BadCredentialsException("incorrect crdentials");
                }
